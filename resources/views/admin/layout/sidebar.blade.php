<nav class="sidebar sidebar-offcanvas" id="sidebar" style="width: 18%">
    <ul class="nav">
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a @if(Session::get('page') == 'users' || Session::get('page') == 'subcribers') style="background:#4B49AC !important; color: #fff !important;" @endif class="nav-link" data-toggle="collapse" href="#ui-users" aria-expanded="false" aria-controls="ui-users">
            <i class="icon-layout menu-icon"></i>
